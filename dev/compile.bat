...
set Z88DK_PATH=z:\home\gra\__varios_progs\z88dk
rem set Z88DK_PATH=z:\__varios_progs\z88dk
...
%utils%\mapcnv.exe ..\map\mapa.map assets\mapa.h 6 5 15 10 15 > nul
rem %utils%\mapcnv.exe ..\map\mapa.map assets\mapa.h 6 5 15 10 15 packed > nul
...
rem 
%utils%\sprcnv2.exe ..\gfx\sprites.png assets\sprites.h 20 extra > nul
...
rem 
%utils%\png2scr.exe ..\gfx\gameover.png ..\gfx\gameover.scr > nul
rem 
%utils%\apultra.exe ..\gfx\gameover.scr ..\bin\gameover.bin > nul
