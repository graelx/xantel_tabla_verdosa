...
#define ENABLE_ORTHOSHOOTERS				// If defined, orthoshooters (tipo 5) are active
...
#define ENEMIES_LIFE_GAUGE		1	//4		// Amount of shots needed to kill enemies.
...
#define MAX_AMMO					0	//99		// If defined, ammo is not infinite!
#define AMMO_REFILL 				0	//50		// ammo refill, using tile 20 (hotspot #4)
...
#define ENABLE_TILANIMS			42		// If defined, animated tiles are enabled.
...
unsigned char behs [] = {
	0, 8, 8, 4, 0, 0, 0, 8, 8, 8, 1, 1, 4, 0,10,10,
...
// G.R.A. Config
// ============================================================================
#define USE_PANTA_GAMEOVER		// Si definido usa una pantalla gráfica de
								// GameOver, equivalente a las otras.
// Para el GameOver mirar en 'pantallas.h' y 'fixed_screens.h'

#define GRA_FLAG_SCR 0
#define GRA_FLAG_PORTAL 1
#define GRA_FLAG_LISTILLO 2

#define GRA_OBJETOS_RECOGER 9

// Macros para lo de las portales
/*#define GRA_MACRO_PORTAL_SRC(_TECLA, _TX, _TY0, _TY1) ((pad0 & _TECLA) == 0) && (p_tx == _TX && (p_ty == _TY0 || p_ty == _TY1))
#define GRA_MACRO_PORTAL_DST(_PANT_DST, _POS_TX_DST, _POS_TY_DST) \
		n_pant = (_PANT_DST);\
		p_x = (_POS_TX_DST)*(8*2)*64;\
		p_y = (_POS_TY_DST)*(8*2)*64;


//		_t = (_TECLA);\_TECLA, , _TY1
#define GRA_MACRO_PORTAL_SRC_2(_TX, _TY0) \
		ptx1 = (_TX);\
		pty1 = (_TY0);\
		cy1 = ((_TY0)-1);

#define GRA_MACRO_PORTAL_DST_2(_PANT_DST, _POS_TX_DST, _POS_TY_DST) \
		_n = (_PANT_DST);\
		ptx2 = (_POS_TX_DST);\
		pty2 = (_POS_TY_DST);
*/

#define GRA_MACRO_PORTAL(_GRA_P0_, _TX, _TY0, _GRA_P1_, _PANT_DST, _POS_TX_DST, _POS_TY_DST) \
		ptx1 = (_TX); pty1 = (_TY0); cy1 = ((_TY0)-1);\
		_n = (_PANT_DST); ptx2 = (_POS_TX_DST); pty2 = (_POS_TY_DST);\
		gra_portal();
